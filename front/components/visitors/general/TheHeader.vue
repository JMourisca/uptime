        ...
        <div class="full-background">
            <div class="inner">
                <div class="upper">
                    ...
                    <IndicatorIcon class="rightfloat" :status="status" :show-text="true"></IndicatorIcon>
                </div>
                <div v-show="showForm" class="subscribe">
...
export default {
    ...
    computed: {
        status() {
            if (this.$store.state.sites.find(a => a.status === 'down') !== undefined) {
                return 'down'
            } else if (this.$store.state.sites.find(a => a.status === 'issue') !== undefined) {
                return 'issue'
            } else {
                return 'up'
            }
